...
<?php 
 if ($weather["humidity_mmin"]>70){echo "<maxtempblue style='font-size:1.1em;'>",$weather["humidity_mmin"]  ;echo "</maxtempblue>%"; }
 else if ($weather["humidity_mmin"]>60){echo "<maxtempyellow style='font-size:1.1em;'>",$weather["humidity_mmin"]  ;echo "</maxtempyellow>%"; }
 else if ($weather["humidity_mmin"]>40){echo "<maxtempgreen style='font-size:1.1em;'>",$weather["humidity_mmin"]  ;echo "</maxtempgreen>%"; }
