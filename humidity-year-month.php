...
<?php //humidity min year 
 ...
 else if ($weather["humidity_ymin"]>0){echo "<maxtempred>",$weather["humidity_ymin"]  ;echo "</maxtempyellow><tunit1>%"; }
...
<?php //humidity max month
 if ($weather["humidity_mmax"]>70){echo "<maxtempblue>",$weather["humidity_mmax"]  ;echo "</maxtempred><tunit1>%"; }
...
<div class="tavgconv" style="margin-left:-12px;"><?php echo $lang['Lowest']?>&nbsp; <?php if ($weather["humidity_mmin"]>70){echo "<maxtempblue>",$weather["humidity_mmin"]  ;echo "</maxtempred>%"; }
...
<?php //temperture min year
 if ($weather["humidity_ymax"]>70){echo "<maxtempblue>",$weather["humidity_ymax"]  ;echo "</maxtempred><tunit1>%"; }
 ...
 else if ($weather["humidity_ymax"]>0){echo "<maxtempred>",$weather["humidity_ymax"]  ;echo "</maxtempyellow><tunit1>%"; }
 ?>
</div></tunit1>
