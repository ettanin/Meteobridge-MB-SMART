...
<?php //humidity min year 
 ...
 ?></div></tunit1>
<div class="tmonthmax" ><?php echo $weather["humidity_ymintime2"]?></div>
...
<?php 
 if ($weather["humidity_mmin"]>70){echo "<maxtempblue style='margin-top:-2px;font-size:1.2em;'>",$weather["humidity_mmin"]  ;echo "</maxtempblue>%"; }
 else if ($weather["humidity_mmin"]>60){echo "<maxtempyellow style='margin-top:-2px;font-size:1.2em;'>",$weather["humidity_mmin"]  ;echo "</maxtempyellow>%"; }
 else if ($weather["humidity_mmin"]>40){echo "<maxtempgreen style='margin-top:-2px;font-size:1.2em;'>",$weather["humidity_mmin"]  ;echo "</maxtempgreen>%"; }
 else if ($weather["humidity_mmin"]>0){echo "<maxtempred style='margin-top:-2px;font-size:1.2em;'>",$weather["humidity_mmin"]  ;echo "</maxtempred>%"; }?>
</div>
