...
<div class="moduleupdatetime"><span><?php if(file_exists($livedata)&&time()- filemtime($livedata)>300)echo '<offlinenew></offlinenew> Offline';else echo "<onlinenew></onlinenew> ".$weather["time"];?></div><br />


<div class="weather34windspeed">
<weather34windunitidspeed>Average</weather34windunitidspeed>
<?php 
//weather34-windaverage speed
if ($weather["wind_speed"]<10){echo "&nbsp;",number_format($weather["wind_speed"]*1.010,2);}else echo number_format($weather["wind_speed"],1);?>
<weather34windunitidunit>10 Min</weather34windunitidunit></div></div>

<div class="weather34windgust">
<weather34windunitidspeed1>Wind Speed</weather34windunitidspeed1>
<?php 
//weather34-windgust
if ($weather["wind_gust_speed"]*$toKnots>=26.9978){echo "<windred>",number_format($weather["wind_gust_speed"],1),"</span>";}
else if ($weather["wind_gust_speed"]*$toKnots>=21.5983){echo "<windorange>",number_format($weather["wind_gust_speed"],1),"</span>";}
else if ($weather["wind_gust_speed"]*$toKnots>=16.1987){echo "<windgreen>",number_format($weather["wind_gust_speed"],1),"</span>";}
else if ($weather["wind_gust_speed"]*$toKnots<16.1987 && $weather["wind_gust_speed"]*$toKnots>=5.39957){echo "",number_format($weather["wind_gust_speed"],1);}
else if ($weather["wind_gust_speed"]<=10){echo"&nbsp;". number_format($weather["wind_gust_speed"]*1.010,2);}
else if ($weather["wind_gust_speed"]<=1){echo"&nbsp;". number_format($weather["wind_gust_speed"],1);}?>
...
</smallrainunit>";}else if ($weather["wind_units"]=="km/h" && $weather["wind_gust_speed"]*$toKnots>=21.5983){echo "<div class=windconvertercircleorange1><torange>".number_format($weather["wind_gust_speed"]*0.621371,1)." </torange><smallrainunit>mph</smallrainunit>";}else if ($weather["wind_units"]=="km/h" && $weather["wind_gust_speed"]*$toKnots>=16.1987){echo "<div class=windconvertercirclegreen1><tgreen>".number_format($weather["wind_gust_speed"]*0.621371,1)." </tgreen><smallrainunit>mph</smallrainunit>";}
else if ($weather["wind_units"]=="km/h" && $weather["wind_gust_speed"]*$toKnots<16.1987){echo "<div class=windconvertercircleblue1>".number_format($weather["wind_gust_speed"]*0.621371,1)." <smallrainunit>mph</smallrainunit>";}
//weather34-convert mph to kmh
else if ($weather["wind_units"]=="mph" && $weather["wind_gust_speed"]*$toKnots>=26.9978){echo "<div class=windconvertercirclered1><tred>".number_format($weather["wind_gust_speed"]*1.609343502101025,1)." </tred><smallrainunit>kmh</smallrainunit>";}else if ($weather["wind_units"]=="mph" && $weather["wind_gust_speed"]*$toKnots>=21.5983){echo "<div class=windconvertercircleorange1><torange>".number_format($weather["wind_gust_speed"]*1.609343502101025,1)." </torange><smallrainunit>kmh</smallrainunit>";}else if ($weather["wind_units"]=="mph" && $weather["wind_gust_speed"]*$toKnots>=16.1987){echo "<div class=windconvertercircleblue1>".number_format($weather["wind_gust_speed"]*1.609343502101025,1)." <smallrainunit>kmh</smallrainunit>";}
...
else if( $weather["wind_direction_avg"]<=348.75){echo $lang['NWN'];}else if( $weather["wind_direction_avg"]<=360){echo $lang['North'];}"&deg;"?></averwordwindword>
</div>
...
<?php //beaufort
if($weather["wind_speed_bft"]>=12){echo '<div class=weather34beaufort6>'.$beaufort12. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=11){echo '<div class=weather34beaufort6>'.$beaufort11. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=10){echo '<div class=weather34beaufort6>'.$beaufort10. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=9){echo '<div class=weather34beaufort6>'.$beaufort9. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=8){echo '<div class=weather34beaufort6>'.$beaufort8. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=7){echo '<div class=weather34beaufort6>'.$beaufort7. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=6){echo '<div class=weather34beaufort6>'.$beaufort6. "&nbsp; " .$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=5){echo '<div class=weather34beaufort4-5>'.$beaufort5. "&nbsp; " .$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=4){echo '<div class=weather34beaufort4-5>'.$beaufort4. "&nbsp; " .$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=3){echo '<div class=weather34beaufort3-4>'.$beaufort3. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=2){echo '<div class=weather34beaufort1-3>'.$beaufort2. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=1){echo '<div class=weather34beaufort1-3>'.$beaufort1. "&nbsp; ".$weather["wind_speed_bft"];}else if($weather["wind_speed_bft"]>=0){echo '<div class=weather34beaufort1-3>'.$beaufort0. "&nbsp; ".$weather["wind_speed_bft"];}?>
 <weather34bftspan>BFT</weather34bftspan></div>
<div class="beaufort1"><?php 
if($weather["wind_speed_bft"]==0){echo "Calm";}else if($weather["wind_speed_bft"]==1){echo "Light Air";}else if($weather["wind_speed_bft"]==2){echo "Light Breeze";}else if($weather["wind_speed_bft"]==3){echo "Gentle Breeze";}else if($weather["wind_speed_bft"]==4){echo "Moderate Breeze";}else if($weather["wind_speed_bft"]==5){echo "Fresh Breeze";}else if($weather["wind_speed_bft"]==6){echo "Strong Breeze";}else if($weather["wind_speed_bft"]==7){echo "Near Gale ".$alert."";}else if($weather["wind_speed_bft"]==8){echo "Gale Force ".$alert."";}else if($weather["wind_speed_bft"]==9){echo "Strong Gale ".$alert."";}else if($weather["wind_speed_bft"]==10){echo "Storm Force ".$alert."";}else if($weather["wind_speed_bft"]==11){echo "Violent Storm ".$alert."";}else if($weather["wind_speed_bft"]>=12){echo "Hurricane Force ".$alert."";}?></valuetext>
</div>