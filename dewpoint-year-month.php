...
<div class="tavgconv" style="margin-left:-5px;"><?php echo $lang['Lowest']?>&nbsp; <?php echo "<maxtempblue style='margin-top:-2px;font-size:1.2em;'>".$weather["dewmmin"]."</maxtempblue>&deg";?>
</div>
