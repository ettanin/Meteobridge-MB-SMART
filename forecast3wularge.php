...
if($wuskydayTempHigh<44.6){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><bluewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></redwu></wulargetemphihome>';}
else if($wuskydayTempHigh>104){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><purplewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></purplewu></wulargetemphihome>';}
else if($wuskydayTempHigh>80.6){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><redwu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></redwu></wulargetemphihome>';}
else if($wuskydayTempHigh>64.4){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><orangewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></orangewu></wulargetemphihome>';}
else if($wuskydayTempHigh>55){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><yellowwu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></yellowwu></wulargetemphihome>';}
else if($wuskydayTempHigh>=44.6){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°F" ><wulargetemphihome><greenwu>'.number_format($wuskydayTempHigh,0).'°<wuunits>F</wuunits></greenwu></wulargetemphihome>';}}
//temp metric wu
if ($weather["temp_units"]=='C'){
if($wuskydayTempHigh<7 && $weather["temp_units"]=='C'){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°C" ><wulargetemphihome><bluewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>C</wuunits></bluewu></wulargetemphihome>';}
else if($wuskydayTempHigh>40){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°C" ><wulargetemphihome><purplewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>C</wuunits></purple></wulargetemphihome>';}
...
else if($wuskydayTempHigh>19){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°C" ><wulargetemphihome><orangewu>'.number_format($wuskydayTempHigh,0).'°<wuunits>C</wuunits></orangewu></wulargetemphihome>';}
else if($wuskydayTempHigh>12.7){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°C" ><wulargetemphihome><yellowwu>'.number_format($wuskydayTempHigh,0).'°<wuunits>C</wuunits></yellowwu></wulargetemphihome>';}
else if( $wuskydayTempHigh>=7){echo '<a class="weather34tipforecast" data-weather34tipforecast="Low '.$wuskydayTempLow.'°C" ><wulargetemphihome><greenwu>'.number_format($wuskydayTempHigh,0).'°<wuunits>C</wuunits></greenwu></wulargetemphihome>';}}
echo '</a><br>';
...
if ($wuskydaynight=='D' && $weather["temp_units"]=='F' && $wuskyheatindex>=89){echo "Heat Index ".$heatindexwu."<heatindexwu>".number_format($wuskyheatindex,0). '°<wuunits>F&nbsp; </wuunits>'.$heatindexalert8a.'</heatindexwu></div>';}
//wu heat index C
if ($wuskydaynight=='D' && $weather["temp_units"]=='C' && $wuskyheatindex>=32){echo "Heat Index ".$heatindexwu." <heatindexwu>".number_format($wuskyheatindex,0). '°<wuunits>C&nbsp; </wuunits>'.$heatindexalert8a.'</heatindexwu></div>';}

else if ($wuskyheatindex<89 && $wuskyhumidity>=70 && $weather["temp_units"]=='F'){echo 	$lang['Humidity']." <bluewuhum>".$wuskyhumidity. '%</bluewuhum></div>';}
else if ($wuskyheatindex<89 && $wuskyhumidity>=50 && $weather["temp_units"]=='F'){echo 	$lang['Humidity']." <yellowwuhum>".$wuskyhumidity. '%</yellowwuhum></div>';}
else if ($wuskyheatindex<89 && $wuskyhumidity>=40 && $weather["temp_units"]=='F'){echo 	$lang['Humidity']."<greenwuhum>".$wuskyhumidity. '%</greenwuhum></div>';}	
else if ($wuskyheatindex<89 && $wuskyhumidity>0 && $weather["temp_units"]=='F'){echo 	$lang['Humidity']." <redwuhum>".$wuskyhumidity. '%</redwuhum></div>';}

else if ($wuskyheatindex<32 && $wuskyhumidity>=70 && $weather["temp_units"]=='C'){echo 	$lang['Humidity']." <bluewuhum>".$wuskyhumidity. '%</bluewuhum></div>';}
else if ($wuskyheatindex<32 && $wuskyhumidity>=50 && $weather["temp_units"]=='C'){echo 	$lang['Humidity']." <yellowwuhum>".$wuskyhumidity. '%</yellowwuhum></div>';}
else if ($wuskyheatindex<32 && $wuskyhumidity>=40 && $weather["temp_units"]=='C'){echo 	$lang['Humidity']." <greenwuhum>".$wuskyhumidity. '%</greenwuhum></div>';}	
else if ($wuskyheatindex<32 && $wuskyhumidity>0 && $weather["temp_units"]=='C'){echo 	$lang['Humidity']." <redwuhum>".$wuskyhumidity. '%</redwuhum></div>';}
...
//snowfall wu
else if ($wuskysnow>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime. '&nbsp;'.$freezing.'';}
else if ($wuskysnow1>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime1. '&nbsp;'.$freezing.'';}
else if ($wuskysnow2>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime2. '&nbsp;'.$freezing.'';}
else if ($wuskysnow3>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime3. '&nbsp;'.$freezing.'';}
else if ($wuskysnow4>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime4. '&nbsp;'.$freezing.'';}
else if ($wuskysnow5>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime5. '&nbsp;'.$freezing.'';}
else if ($wuskysnow6>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime6. '&nbsp;'.$freezing.'';}
else if ($wuskysnow7>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime7. '&nbsp;'.$freezing.'';}
else if ($wuskysnow8>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime8. '&nbsp;'.$freezing.'';}
else if ($wuskysnow9>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime9. '&nbsp;'.$freezing.'';}
else if ($wuskysnow10>0 )  {echo $infowu.'<blue>'.$lang['Snow-Metar'].'</blue> '.$wuskydayTime10. '&nbsp;'.$freezing.'';}
//rainfall wu
...
if ($wuskydayTempHigh2>80.6 ){  echo "<div class=temperaturenext><redwuhum>".number_format($wuskydayTempHigh2,0). "°<wuunitstemperaturenext>".$weather['temp_units']."</wuunitstemperaturenext></redwuhum><nextperiod>", $wuskydayTime2."</nextperiod>";}
else if ($wuskydayTempHigh2>64.4 ){  echo "<div class=temperaturenext><orangewuhum>".number_format($wuskydayTempHigh2,0). "°<wuunitstemperaturenext>".$weather['temp_units']."</wuunitstemperaturenext></orangewuhum><nextperiod>", $wuskydayTime2."</nextperiod>";}
else if ($wuskydayTempHigh2>55 ){  echo "<div class=temperaturenext><yellowwuhum>".number_format($wuskydayTempHigh2,0). "°<wuunitstemperaturenext>".$weather['temp_units']."</wuunitstemperaturenext></yellowwuhum><nextperiod>", $wuskydayTime2."</nextperiod>";}
else if ($wuskydayTempHigh2>44.6 ){  echo "<div class=temperaturenext><greenwuhum>".number_format($wuskydayTempHigh2,0). "°<wuunitstemperaturenext>".$weather['temp_units']."</wuunitstemperaturenext></greenwuhum><nextperiod>", $wuskydayTime2."</nextperiod>";}
...
if ($wuskydayTempHigh2>27 ){  echo "<div class=temperaturenext><redwuhum>".number_format($wuskydayTempHigh2,0). "°<wuunitstemperaturenext>".$weather['temp_units']."</wuunitstemperaturenext></redwuhum><nextperiod>", $wuskydayTime2."</nextperiod>";}
