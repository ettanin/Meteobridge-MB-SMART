...
<div class="tavgconv" style="margin-left:-12px;">&nbsp;<?php echo $lang['Lowest']?>&nbsp; <?php echo "<maxtempblue style='margin-top:-2px;font-size:1.2em;'>".$weather["thb0seapressmmin"];echo "</maxtempblue>";?>
</div>
