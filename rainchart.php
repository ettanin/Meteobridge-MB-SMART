...
<main class="grid1">
  ...
  <iframe  src="ws1001charts/todayrainfallsmall.php" frameborder="0" scrolling="no" width="375px"></iframe>
  ...
  <iframe  src="ws1001charts/monthlyrainfallsmall.php" frameborder="0" scrolling="no" width="375px"></iframe>
   
  </articlegraph> 
  
  <articlegraph> 
  <div class=actualt><?php echo date('Y');?> <blue>Rainfall <?php echo "<smalluvunit>",$rainunit ;?></smalluvunit></blue></div>  
  <iframe  src="ws1001charts/yearlyrainfallsmall.php" frameborder="0" scrolling="no" width="375px"></iframe>
   
  </articlegraph> 
  
   <articlegraph style="height:100px">  
  <div class="lotemp">
  <?php echo $info?> 
