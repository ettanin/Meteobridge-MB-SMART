...
<style>
    ...
    .weathersetuptitle {
        ...
        padding: 5px;
        border: 0;
        background: rgba(67, 58, 80, 1.000);
        border-radius: 5px;
        color: #fff;
        width: 600px;
        margin: 0 auto;
    ...
    .theframe {
        ...
        font-family: Arial, Helvetica, sans-serif;
        color: #fff;
        border: 1px solid rgba(7, 114, 125, 1.000, .4);
        margin: 0 auto;
        margin-top: 10px;
        margin-bottom: 10px;
        width: 960px;
        ...
        padding: 5px;
        border-radius: 4px;
        -webkit-box-shadow: 4px 7px 20px -5px rgba(0, 0, 0, 0.75);
    ...
    .weatheroptions {
        ...
        border-bottom: 18px solid #e9ebf1;
        width: 75%
    }
    ...
    .weatheroptions .choose {
        background: rgba(7, 114, 125, 1.000);
        border-radius: 4px;
        padding: 5px;
        padding-right: 10px;
        font-size: 14px;
    ...
    .weatheroptions .choose2 {
        background: rgba(86, 95, 103, 1.000);
        border-radius: 3px;
        padding: 5px;
        padding-right: 10px;
        font-size: 14px;
    ...
    #weatherpopup {
        ...
        text-align: center;
        border: 1px solid #e9ebf1;
        border-bottom: 23px solid rgba(40, 39, 39, 0.7);
        color: #fff;
        padding: 10px
    }
    ...
    *:focus {
    ...
    input {
        ...
        color: #fff;
        border: 2px solid rgba(86, 95, 103, 1.000);
        box-shadow: none;
        margin: 0 auto;
        margin-top: 10px
    }
    ...
    .btn:hover {
        background-color: rgba(86, 95, 103, 1.000)
    }
    ...
    orange {
        color: rgba(236, 87, 27, 1.000)
    }

    green {
        color: rgba(67, 58, 80, 1.000)
    }
...
<body>
    <div class="loginformarea">
        ...
        function showForm($error = "LOGIN")
        {
            ...
            <div class="login_screen" style="width:60%;max-width:600px;margin:0 auto;color:rgba(24, 25, 27, 1.000);border:solid 1px grey;padding:10px;
            border-radius:4px;font-size:14px"> <?php echo 'Your Current PHP version is :<orange><b> ' . phpversion(), '</b></orange> <br>(PHP 5.6 or higher PHP 7+ is  advised if you are not already using these versions)'; ?>
            ...
            <div span style="width:auto;margin:0 auto;text-align:center;color:#fff;background:0;font-family:arial;padding:20px;border-radius:4px;font-size:14px">
                ...
                if (isset($_POST['submit_pwd'])) {
                    ...
                    if ($pass != $Password) {
                        showForm("Dashboard Meteobridge MB-SMART EASY SETUP");
                        exit();
                    }
                } else {
                    showForm("Dashboard Meteobridge MB-SMART EASY SETUP");
            ...
            <div span style="width:450px;margin:0 auto;margin-top:10px;text-align:center;color:#4a636f;background:0;
                    ...
                    <p>
                        ...
                        <div class="weatheroptions">
                            <div class="weathersectiontitle">
                                ...
                                Database is No longer Required (may be useful in the future)<br> ** see file in download and important read file called <strong>nomysqlsetup.txt</strong> </div>
                            <p>
                                ...
                                <p>
                                    ...
                                    <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="0" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                            <circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> ** see file in download and important read file called <strong>nomysqlsetup.txt </strong> </span><br>
                                    <br>
                        ...
                        <p>
                            ...
                            <p>
                                <div class="weatheroptionssidebar">
                                    <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                        <circle cx="16" cy="16" r="14" /></svg> Meteobridge Hardware
                                    ...
                                    <p>
                                        ...
                                        <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                            <circle cx="16" cy="16" r="14" /></svg> Davis Hardware
                                        ...
                                        <p>
                                            ...
                                            <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                <path d="M16 14 L16 23 M16 8 L16 10" />
                                                <circle cx="16" cy="16" r="14" /></svg> Fixed Charts
                                ...
                                <p>
                                    ...
                                    <div class="weatheroptions">
                                        ...
                                        <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                <path d="M16 14 L16 23 M16 8 L16 10" />
                                                <circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> METEOBRIDGE-API path example: http://yourdomain/mbridge/MBrealtimeupload.txt</span><br>

                                        <br>

                                        <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                <path d="M16 14 L16 23 M16 8 L16 10" />
                                                <circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> METEOBRIDGE path example: http://yourdomain/mbridge/MBrealtime.txt</span><br>
                                        ...
                                        <p>
                                            ...
                                            <div class="weathersectiontitle">
                                                ...
                                                Meteobridge Chart Data (Now uses direct data from meteobridge)</div>
                                            <p>
                                                ...
                                                <p>
                                                    ...
                                                    <p>
                                                        ...
                                                        <div class="weathersectiontitle">
                                                            ...
                                                            Your Weather Station Hardware</div>
                                                        <p>
                                                            <div class="stationvalue">
                                                            ...
                                                            <p>
                                                                ...
                                                                <div class="weathersectiontitle">
                                                                    ...
                                                                    When Did You Install Your Hardware Currently in Use </div>
                                                                <p>
                                    ...
                                    <div class="weatheroptions">
                                        <div class="weathersectiontitle">
                                            ...
                                            Location Details and Station Name</div>
                                        <p>
                                    ...
                                    <p><br>
                                        ...
                                        <div class="weatheroptions">
                                            ...
                                            <div class="weathersectiontitle">
                                                ...
                                                Set the Units you wish to display controls unit switching & set color theme also set notifications display</div>
                                            <p>
                                                ...
                                                <span style="color:#777;"> set: <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                ...
                                                <p>
                                                    ...
                                                    <span style="color:#777;"> set: <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#25292D" stroke="rgba(230, 232, 239, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                            <circle cx="16" cy="16" r="14" /></svg> dark, <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(144, 177, 42, 1.000)" stroke="rgba(230, 232, 239, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                            <circle cx="16" cy="16" r="14" /></svg> light</span>
                                                    <p>
                                                        ...
                                                        <span style="color:rgba(86, 95, 103, 1.000);">
                                                            <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(102, 188, 199, 1.000)" stroke="rgba(102, 188, 199, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                <circle cx="16" cy="16" r="14" /></svg> <strong> yes to show notifications
                                                                <svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                    <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                    <circle cx="16" cy="16" r="14" /></svg> no to disable</strong><br>
                                                            <br>
                                                    ...
                                                    <p>
                                                        ...
                                                        <p>
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                    <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                    <circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> airqualitymodule.php <orange>display airquality</orange><br></span>
                                                                                <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> webcamsmall.php</span>
                                                                                    <orange>display webcam</orange>.*
                                                                                    add your url/path to wecam image using option below <br>
                                                                                </span>
                                                                                <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> chanceofprecip.php</span>
                                                                                    <orange>display probability of precipitation either snow or rain </orange><br>
                                                                                </span>

                                                                                <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> weather34uvsolar.php</span>
                                                                                    <orange>display uv and solar radiation if you have hardware</orange> <br>
                                                                                </span>

                                                                                <span style="color:#777;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg><span style="color:#777;"> solaruvwu.php</span>
                                                                                    <orange>display Weather Underground Day UV forecast and if you have only solar radiation </orange> <br>
                                                                                </span>
                                                                                ...
                                                                                <label name="positionprecip"></label>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> d-m-Y <span style="color:#777;">for DAY MONTH YEAR format (12-03-2017)</span></span><br>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> m-d-Y <span style="color:#777;">for MONTH DAY YEAR format (03-12-2017)</span></span><br>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> Y-m-d <span style="color:#777;">for YEAR MONTH DAY format (2017-12-03)</span></span><br>
                                                                                <br>

                                                                                <span style="color:#777;font-weight:600;">Main Clock format<br></span>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> 24 <span style="color:#777;">Main Clock output example 17:32:12 </span></span><br>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> 12 <span style="color:#777;">Main Clock output example 5:32:12 pm</span></span><br> <br>

                                                                                <span style="color:#777;font-weight:600;">Time format<br></span>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> H:i:s <span style="color:#777;"> 17:34:22 format</span> </span><br>

                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> g:i:s a <span style="color:#777;"> 05:34:22 am format</span></span><br>

                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> g:i:s <span style="color:#777;"> 05:34:22 format</span></span><br> <br>


                                                                                <span style="color:#777;font-weight:600;">Short Time format used for Sunrise/Set & Moonrise/Set areas<br></span>
                                                                                <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> H:i <span style="color:#777;">17:34 format</span></span><br>

                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> g:i a <span style="color:#777;">05:34 am format</span></span><br>

                                                                                <span style="color:rgba(86, 95, 103, 1.000);"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> g:i <span style="color:#777;">05:34 format</span></span><br>
                                                                                ...
                                                                                <span style="color:rgba(86, 95, 103, 1.000);font-weight:normal;"><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                        <circle cx="16" cy="16" r="14" /></svg> false = </span> <span style="color:#777;font-weight:normal;">not used as of 27th April 2017 always false</span>
                                                                                ...
                                                                                <span style="color:#777;"><strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                            <circle cx="16" cy="16" r="14" /></svg> No</strong> use if do <span style="color:rgba(86, 95, 103, 1.000)">NOT HAVE</span> external links to use<br>
                                                                                    <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                            <circle cx="16" cy="16" r="14" /></svg> Yes</strong> use if you do <span style="color:rgba(7, 114, 125, 1.000)"> HAVE</span> <span style="color:#777;"> external links to use<br>
                                                                                    </span></span>
                                                                                <br>
                                                                                ...
                                                                                <span style="color:#777;"><strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="#FF793A" stroke="#FF793A" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                            <circle cx="16" cy="16" r="14" /></svg> No</strong> use if you do <span style="color:rgba(86, 95, 103, 1.000)">NOT WANT</span> languages selection<br>
                                                                                    <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="rgba(7, 114, 125, 1.000)" stroke="rgba(7, 114, 125, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                            <circle cx="16" cy="16" r="14" /></svg> Yes</strong> use if you do <span style="color:rgba(7, 114, 125, 1.000)"> WANT</span> <span style="color:#777;"> languages selection<br>
                                                                                    </span></span>
                                                                                                                ...
                                                                                                                <span style="color:#F75C46;"><svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                    ...
                                                                                                                    <span style="color:#777;">
                                                                                                                        <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                                                            <circle cx="16" cy="16" r="14" /></svg> *option temperature.php default without indoor temperature displayed <br>
                                                                                                                        <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                            <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                                                            <circle cx="16" cy="16" r="14" /></svg> *temperaturein.php shows indoor temp icon<br><br></span>
                                                                                                                    ...
                                                                                                                    <p>
                                                                                                                        ...
                                                                                                                        <span style="color:#F75C46;"><svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="#777" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                            ...
                                                                                                                            <span style="color:#777;">
                                                                                                                                <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                                    <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                                                                    <circle cx="16" cy="16" r="14" /></svg> *options select your regular Weather Station Hardware Supplier choose none if not shown or do not wish to show in menu<br><br></span>
                                                                                                                            ...
                                                                                                                            <p>
                                                                                                                                ...
                                                                                                                                <div class="stationvalue">
                                                                                                                                    You can update or backup the template using this MB-SMART updater or backup feature</div> <br><br>
                                                                                                                                <svg id="i-chevron-right" viewBox="0 0 32 32" width="14" height="14" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
                                                                                                                                    <path d="M12 30 L24 16 12 2" />
                                                                                                                                </svg><a href="update-mbsmart.php" title="Update MB SMART Template" target="_blank"><span style="font-weight:600;color:white;padding:3px;border-radius:3px;background:#01a4b5">
                                                                                                                                        CLICK HERE TO UPDATE or RUN A BACKUP</span></a>

                                                                                                                                <br><br>
                                                                                                                                <svg id="i-info" viewBox="0 0 32 32" width="12" height="12" fill="none" stroke="rgba(86, 95, 103, 1.000)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                                                                                                                    <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                                                                                    <circle cx="16" cy="16" r="14" /></svg>
                                                                                                                                <span style="color:#23252d" ;>*Make sure you have the mb-smart-updater.zip located in the same directory or a backup file generated by the updater screen .</span>
                                                            ...
                                                            <div class="weatheroptions">
                                                                ...
                                                                <strong><svg id="i-info" viewBox="0 0 32 32" width="10" height="10" fill="0" stroke="#F75C46" stroke-linecap="round" stroke-linejoin="round" stroke-width="16.25%">
                                                                        <path d="M16 14 L16 23 M16 8 L16 10" />
                                                                        <circle cx="16" cy="16" r="14" /></svg></strong><span style="color:#777;"> ** see file in download and important read file called nomysqlsetup.txt </span><br>
                                                                <br>
                                                            ...
                                                            <p>
                                                                ...
                                                                <a href="http://www.meteobridge.com/wiki/index.php/Home" title="http://www.meteobridge.com/wiki/index.php/Home" target="_blank"><img src="img/meteobridge.svg" width="120" style="float:right;margin-top:-10px" /></a><br><br><span style="font-size:12px;color:#777;">
                                                                    <center><?php echo "2015-"; ?><?php echo date('Y'); ?> &copy;WEATHER34 MB-<orange>SMART</orange> Weather Template</center>
                                                                </span>
                                                            </p>
                </form>
            </p>
