...
orange{color:rgba(255, 124, 57, 1.000)}
</style>
<?php
...
<body>
<div class="weather34darkbrowser" url="<?php echo date('l') ;?> Temp Hi:<?php echo $weather["temp_today_high"]. "$tempunit" ;?> Lo:<?php echo $weather["temp_today_low"]. "$tempunit" ;?> | Hum Hi:<?php echo $weather["humidity_max"];?>% Hum Lo:<?php echo $weather["humidity_min"];?>%"></div> 
