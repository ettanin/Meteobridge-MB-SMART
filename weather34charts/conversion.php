...
$pressureconv='33.8637526';
$temperatureconvlo='parseFloat(rowData[2]- 32)*5/9';
$temperatureconv='parseFloat(rowData[1]- 32)*5/9';
$dewpointconv='parseFloat(rowData[8]- 32)*5/9';
$dewpointconv2='parseFloat(rowData[3]- 32)*5/9';
$dewpointconv3='parseFloat(rowData[4]- 32)*5/9';
$windconv = "1.60934";
$rainfallconv='25.4';
