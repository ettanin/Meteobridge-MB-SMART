...
<html>
	...
	function processData2(allText) {
		...
		title: {
            text: " <?php echo $stationlocation ;?> UV Index Recorded (UVI) <?php echo date('D F jS Y') ;?>",
			fontSize: 11,
			fontColor:' #ccc',
			fontFamily: "arial",
        },
...
<body>
<div class="weather34darkbrowser" url="<?php echo $stationlocation;?> UV-INDEX Recorded (UVI) <?php echo date('D F jS Y') ;?>"></div> 
<div style="width:auto;background:0;padding:0px;margin-left:5px;font-size: 12px;border-radius:3px;">
<div id="chartContainer" style="height: 375px; width:800px;margin-left:5px;border-radius:4px;font-size: 12px;color:#fff;"></div></div>
