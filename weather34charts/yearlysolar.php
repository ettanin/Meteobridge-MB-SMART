...
<html>
	...
	function drawChart( dataPoints1 , dataPoints2 ) {
		...
		title: {
            text: "<?php echo $stationlocation;?> Solar Radiation (<?php echo 'wm/2' ;?>) <?php echo date('Y') ;?>",
			fontSize: 12,
			fontColor:' #aaa',
			fontFamily: "arial",
        },
        ...
        return e.value .toFixed(0) + " <?php echo 'wm/2' ;?> " ;  
			...
			labelFontSize:14,
			labelBackgroundColor: "#FF8841",
			valueFormatString:"##.## <?php echo 'wm/2' ;?>",
		}	 
...
<body>
<div class="weather34darkbrowser" url="<?php echo $stationlocation;?> Solar Radiation Recorded (WM/2) <?php echo date('Y') ;?>"></div> 
