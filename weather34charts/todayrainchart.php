...
<main class="grid1">
  ...
  <iframe  src="ws1001charts/todayrainfallmedium.php" frameborder="0" scrolling="no" width="100%"></iframe>
   
  </articlegraph> 
  
  
  <articlegraph> 
  <div class=actualt>Today <blue>Rainfall Periods <?php echo "<smalluvunit>",$rainunit ;?></smalluvunit></blue></div>  
  <iframe  src="ws1001charts/todayrainratemedium.php" frameborder="0" scrolling="no" width="100%"></iframe>
