...
<div class="tavgconv" style="margin-left:-9px;"><?php echo $lang['Lowest']?>&nbsp; <?php echo "<maxtempblue style='margin-top:-2px;font-size:1.2em;'>".$weather["tempmmin"]."</maxtempblue>&deg";?>
</div>
