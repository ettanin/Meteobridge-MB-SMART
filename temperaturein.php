...
else if($weather["temp_units"]=='F' && ($weather["dewpoint"]>0)){ echo   "<div class=tempconverter1><div class=tempmodulehome-10-0c>&nbsp;".$weather['dewpoint'].'&deg;<smalltempunit2>'.$weather["temp_units"];}
