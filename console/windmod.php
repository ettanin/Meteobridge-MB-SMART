...
else if($weather["wind_speed"]<=50 && $weather["wind_units"]=="km/h"){ echo "<orange>".$runningsfast."</orange>";}
else if($weather["wind_speed"]<=200 && $weather["wind_units"]=="km/h"){ echo "<red>".$runningsfast."</red>";}
...
else if($weather["wind_speed"]<=75 && $weather["wind_units"]=="mph"){ echo "<orange>".$runningsfast."</orange>";}
else if($weather["wind_speed"]<=200 && $weather["wind_units"]=="mph"){ echo "<red>".$runningsfast."</red>";}
echo "</tempman>";?>
</div></div>
