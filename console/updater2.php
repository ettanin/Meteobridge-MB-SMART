...
(function(a){a(document).ready(function(){a.ajaxSetup({cache:true,success:function(){a("#uvindex").show()}});var c=a("#uvindex");c.load("uvindexmod.php");var b=setInterval(function(){c.load("uvindexmod.php")},120000)})})(jQuery);
