...
$data = file_get_contents($url); // now lets put the contents of the file into a variable
$weather34luftdaten = json_decode($data,true); // API decode the JSON feed
...
.extraqiinfo{position:relative;top:0px;font-size:.9em;color:#aaa;left:50px;width:170px}
