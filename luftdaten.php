...
<div class=indoorsvgnestvalue> <?php echo $aqiweather["pm"]?></div>
<div class="trendicon"><?php echo $windchillwu;?></div></div>
<div class="extraqiinfo">
<?php echo "Station ID:" .$aqiweather["stationid"]?><br>
<?php echo "Updated:<blue> " .$aqiweather["updatedtime"] ?></blue>
</div>
...
<path fill="
<?php
if ($weather["cloudbase3"]<1500) {
    echo "#44a6b5";
} elseif ($weather["cloudbase3"]>=4000) {
    echo "#d05f2d";
} elseif ($weather["cloudbase3"]>=1500) {
    echo "#e6a141";
}
...
<?php if ($weather["cloudbase3"]>0) {
    echo $weather["cloudbase3"]."<smalluvunit>ft</smalluvunit><br>".round($weather["cloudbase3"]*0.3048, 0)."<smalluvunit>mt</smalluvunit>";
}?>
</div>
