...
<head>
  <meta charset="UTF-8">
  <title>Weather34 Weather Underground Summary Forecast</title>
...
margin-top:-44px;margin-left:72px;padding:2px;line-height:10px;font-size:9px}.svgimage{background:rgba(0, 155, 171, 1.000);-webit-border-radius:2px;border-radius:2px;}orange1{color:#aaa;}

.greydesc{color:#c5c5c5;margin-left:40px;margin-top:-20px;position:absolute;font-size:0.85em}
.summarydesc{position:relative;color:#f8f8f8;margin-left:5px;margin-top:-5px;font-size:0.75rem;width:100%;}
...
summary{font-size:.9em;color:#aaa;display:none}blue1{color:#009bb4}value{font-size:.95em;color:#aaa}valuer{color:#aaa;font-size:.9em;}thunder{font-size:.9em;color:#aaa}wind{color:#bbb;font-size:.9em}
</style>
<div class="weather34darkbrowser" url="Weather Underground Summary Forecast"></div>  
<main class="grid">
  <article>  
