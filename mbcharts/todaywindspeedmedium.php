...
<body>
<div id="chartContainer2" class="chartContainer2" style="width:100%;height:220px;padding:0;margin-top:-25px;border-radius:3px;border: 1px solid rgba(245, 247, 252,.02);
