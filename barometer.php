...
if ($weather["barometer_trend"] < 0) {
    ...
    echo number_format($weather["barometer_trend"],3).'<blue> '.$lang['Last Hour'].'</blue></valuetextba><pressureunits>';
} elseif ($weather["barometer_trend"] > 0) {
    echo '<br><rising><rise> '.$risingsymbol.'&nbsp;</rise>+<valuetextba> ';
    echo number_format($weather["barometer_trend"],3).'<blue> '.$lang['Last Hour'].'</blue></valuetextba>';
} else {
