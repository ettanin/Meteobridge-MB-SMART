...
var refweather34Day = referenceweather34Moon / 86400000;var phase = (day - refweather34Day) % 29.530588853*1.22;var s=String;
...
var rf=Math.min(3+4*((phase-30)/28.5),1);	var rc=Math.abs(rf*50);	var rb=(rf<0) ? "0" : "1";weather34moonCurve="M 50,0 "+ "a "+s(lc)+",50 0 0 "+lb+" 0,100 "+ "a "+s(rc)+",50 0 0 "+rb+" 0,-100";
